...
public class CLIParser implements Runnable, Cancellable {
	...
	public CLIParser(SimpleServentListener listener, DetectionFailureWorker detectionFailureWorker) {
...
//		commandList.add(new DHTPutCommand());
		commandList.add(new StopCommand(this, listener, detectionFailureWorker));
		commandList.add(new AddFileCommand(listener.getMutex()));
		commandList.add(new AddFriendCommand(listener.getMutex()));
		commandList.add(new QuitNodeCommand(this, listener ,(SuzukiKasamiMutex) listener.getMutex()));
		commandList.add(new ViewFileCommand(listener.getMutex()));
		commandList.add(new RemoveFileCommand(listener.getMutex()));
	}
